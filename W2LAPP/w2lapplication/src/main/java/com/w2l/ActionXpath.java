...
public class ActionXpath {
	...
	static String clickonqualification = "//div[@aria-labelledby='mui-component-select-qualifications']";
	static String selectqualification = "//li[.='10th Pass']";
	...
	static String age = "//input[@name='Age']";
	...
	static String clickonapply = "(//span[.='Apply Now'])[1]";
